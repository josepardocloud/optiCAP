...
// Verificar que solo se puedan dar permisos a usuarios con roles "usuario" o "super_usuario"
if (!in_array($usuario['rol'], ['usuario', 'super_usuario'])) {
    redirectTo('modules/usuarios/usuarios.php?error=Solo se pueden asignar permisos a usuarios con rol Usuario o Super Usuario');
    exit();
}

// Obtener procesos y actividades - CONSULTA CORREGIDA
...
// Agrupar por proceso - CORREGIDO: sin la columna descripcion de procesos
$procesos = [];
...
if ($_POST) {
    try {
        ...
        $db->commit();
        $mensaje = "Permisos actualizados exitosamente para el usuario " . $usuario['nombre'];
...
<body>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div>
                                        <strong class="d-block fs-5"><?php echo $usuario['nombre']; ?></strong>
                            ...
                            <div class="col-md-3">
                                ...
                                ?> fs-6"><?php echo ucfirst(str_replace('_', ' ', $usuario['rol'])); ?></span>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <span class="fs-6"><?php echo $usuario['ultimo_login'] ? date('d/m/Y H:i', strtotime($usuario['ultimo_login'])) : 'Nunca'; ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <a href="acciones.php?action=desactivar&id=<?php echo $usuario_id; ?>" 
                                   ...
                                   onclick="return confirm('¿Desactivar usuario <?php echo $usuario['nombre']; ?>?')">
                                    <i class="fas fa-user-slash me-2"></i>Desactivar
                                </a>
                                <?php else: ?>
                                <a href="acciones.php?action=activar&id=<?php echo $usuario_id; ?>" 
                                   class="btn btn-outline-success w-100"
                                   onclick="return confirm('¿Activar usuario <?php echo $usuario['nombre']; ?>?')">
                    ...
                    <div class="card">
                        <div class="card-header bg-info text-white">
                            <h5 class="card-title mb-0">
                                ...
                                <small class="d-block mt-1">
                                    Usuario: <strong><?php echo $usuario['nombre']; ?></strong> 
                        ...
                        <div class="card-body">
                            <div class="alert alert-info">
                                ...
                                Seleccione las actividades para las cuales <strong><?php echo $usuario['nombre']; ?></strong> tendrá permisos de modificación. 
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6 text-end">
                                    ...
                                    <span class="text-muted">actividades seleccionadas para <?php echo $usuario['nombre']; ?></span>
                                </div>
                            </div>
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end border-top pt-3">
                                <button type="submit" class="btn btn-primary btn-lg">
                                    <i class="fas fa-save me-2"></i> Guardar Permisos para <?php echo $usuario['nombre']; ?>
                                </button>
    ...
    <script>
        ...
        document.getElementById('formPermisos').addEventListener('submit', function(e) {
            const checkboxes = document.querySelectorAll('.permiso-checkbox:checked');
            const usuarioNombre = '<?php echo $usuario['nombre']; ?>';
