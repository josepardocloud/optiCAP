                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="buscarUsuario" placeholder="Buscar por nombre, usuario o email...">
                            </div>
                        </div>
                            ...
                            <table class="table table-hover table-striped" id="tablaUsuarios">
                                ...
                                <tbody>
                                    ...
                                    <tr class="usuario-fila" 
                                        ...
                                        data-usuario="<?php echo strtolower($usuario['usuario']); ?>"
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function filtrarUsuarios() {
            ...
            filas.forEach(fila => {
                ...
                if (textoBusqueda && !nombre.includes(textoBusqueda) && !usuario.includes(textoBusqueda) && !email.includes(textoBusqueda)) {
                    mostrar = false;
                }
