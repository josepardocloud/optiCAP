                        ...
                        <div class="card text-white bg-primary">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h5 class="card-title">Eventos (30 días)</h5>
                                        <h2><?php echo $estadisticas['total_logs']; ?></h2>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        ...
                                        <h2><?php echo $estadisticas['exitos']; ?></h2>
                                    </div>
                                    <div class="align-self-center">
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        ...
                                        <h2><?php echo $estadisticas['fallos']; ?></h2>
                                    </div>
                                    <div class="align-self-center">
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        ...
                                        <h2><?php echo $estadisticas['ips_unicas']; ?></h2>
                                    </div>
                                    <div class="align-self-center">
